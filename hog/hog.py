...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    while i<=10:
        ...
        max_scoring_num=ave(i,dice)
        if max_scoring_num>high:
            high=max_scoring_num
            number=i   
        i+=1 
    return number
    # END PROBLEM 9
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if score<=80:
        ...
        return bacon_strategy(score, opponent_score, cutoff=7, num_rolls=1)
    else:
        return 2
